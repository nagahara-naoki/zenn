---
title: "Angular Signals入門：signal・computed・effectの使い分け"
emoji: "📶"
type: "tech"
...
Angular 22を前提に、この3つを順に見ていきます。あわせて、3つのどれでもない場面で使う`linkedSignal()`と`resource()`にも触れます。目の前の状態がどう決まるかを基準に、使うAPIを選べるようになることがゴールです。
