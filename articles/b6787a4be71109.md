---
title: "TypeScriptで理解するDI：依存を外から渡す設計"
emoji: "🔌"
type: "tech"
...
「DIを入れる」と聞くと、DIコンテナの導入を思い浮かべるかもしれません。しかし、DIの出発点はライブラリ選びではありません。
...
DIによって得られるのは、特定のライブラリが提供する仕組みだけではありません。**業務処理が何を必要とし、実行時に何を使うのかをコードから追える状態**です。
