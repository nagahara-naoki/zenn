---
title: "JavaScriptの関数は役割から選ぶ：入力・戻り値・副作用の整理"
emoji: "🧩"
type: "tech"
...
書き方を一覧で覚えても、実際にコードを書くと「どれを使うべきか」で迷います。構文の違いだけでは、選択基準が見えないからです。

先に決めるのは、**関数の役割**です。役割が決まれば必要な性質が分かり、適した書き方を絞れます。
...
関数の書き方で迷う原因は、構文の知識不足とは限りません。役割を決める前に、書き方から選ぼうとしている可能性があります。
