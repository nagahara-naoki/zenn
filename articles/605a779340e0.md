...
決済APIへリクエストを送ったところ、レスポンスが返らないままタイムアウトしました。ここで再送するのは危険です。最初の決済がすでに完了していれば、二重決済になります。かといって諦めれば、本当に届いていなかったとき注文が消えます。

もう一度送ってよいのでしょうか。

この問題に対処する性質が冪等性（べきとうせい）です。回数は問いません。同じ操作を複数回実行しても、サーバーに対する意図した効果が1回実行したときと変わらないことを指します。
...
```mermaid
%%{init: {'theme':'base','themeVariables':{'primaryColor':'#f5f5f5','primaryBorderColor':'#525252','primaryTextColor':'#1a1a1a','secondaryColor':'#e5e5e5','secondaryBorderColor':'#525252','secondaryTextColor':'#1a1a1a','tertiaryColor':'#fafafa','tertiaryBorderColor':'#525252','tertiaryTextColor':'#1a1a1a','mainBkg':'#f5f5f5','nodeBorder':'#525252','nodeTextColor':'#1a1a1a','clusterBkg':'#fafafa','clusterBorder':'#525252','lineColor':'#7d7d7d','textColor':'#1a1a1a','edgeLabelBackground':'#f5f5f5','actorBkg':'#f5f5f5','actorBorder':'#525252','actorTextColor':'#1a1a1a','actorLineColor':'#7d7d7d','signalColor':'#7d7d7d','signalTextColor':'#7d7d7d','noteBkgColor':'#e5e5e5','noteBorderColor':'#525252','noteTextColor':'#1a1a1a','activationBkgColor':'#e5e5e5','activationBorderColor':'#525252','labelBoxBkgColor':'#f5f5f5','labelBoxBorderColor':'#525252','labelTextColor':'#1a1a1a','loopTextColor':'#1a1a1a'}}}%%
sequenceDiagram
