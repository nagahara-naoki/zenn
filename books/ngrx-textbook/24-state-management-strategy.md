...
ここまで、Classic Store、SignalStore、ComponentStoreを学んできました。しかし、状態管理の選択肢はNgRxだけではありません。Angular標準のSignalやServiceで足りる場面もあります。学んだ道具を常に使うのではなく、目の前の状態に見合う手法を選ぶことが重要です。
