...
アンチパターンとは、一見するとうまくいくように見えて、あとで問題を引き起こす書き方のことです。本書でこれまで学んできた原則は、裏を返せば「こう書くと崩れる」という失敗を避けるためのものでした。この章では、その失敗を、具体的なパターンとして並べます。それぞれについて、どんな症状か、なぜ問題なのか、どう直すのかを見ていきます。
