...
イベント予約APIなら、イベント、予約、会場、主催者などがリソースの候補です。業務概念をURIへ写し、コレクション、個別リソース、関連を一貫して表していきます。
...
URIはコード、ログ、監視、外部連携に長く残ります。利用者が理解する業務概念を使い、テーブル名やフレームワーク名から切り離しておけば、内部を変えても同じ名前を保ちやすくなります。
