...
前章では、Query、Router、Table、Virtual、Form、Startの役割を大まかに眺めました。この章では、TanStackという名前の成り立ちと、6つの道具に共通する設計思想を見ます。

中心にあるのは、見た目とロジックを分けるHeadlessという考え方と、値から型を推論して書き間違いを防ぐ設計です。個々の使い方はこの先の章で1つずつ扱うので、ここでAPIを暗記する必要はありません。
