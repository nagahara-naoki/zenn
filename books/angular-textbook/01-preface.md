...
本書は、Angularを初めて学ぶ人から、実務で設計判断の根拠を固めたい人までを対象にした教科書です。機能の使い方に加えて、「なぜそう動くのか」「どう設計すべきか」まで掘り下げます。
...
- **新旧を比較すること**: 現在の標準的な書き方を主軸に置き、以前の書き方と対比します。既存コードを読み解く力を養い、書き方が変わった理由を理解するためです。
...
本書は序章と24の章で構成され、読み進めるにつれて扱う内容が高度になります。
