...
SignalStoreは、第50章で自前で書いたSignalベースのStore Serviceを、体系的に、再利用しやすくしたものだと考えると、理解しやすくなります。Reduxパターンの厳格さよりも、簡潔さと使いやすさを重視した設計です。この節では、両者の違いと、どちらをいつ選ぶべきかを整理し、第10部全体を締めくくります。
